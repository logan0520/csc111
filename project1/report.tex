...
\textbf{Total moves:} 19 moves

\textbf{Final score:} 185 points

\section*{Lose condition(s)}
Description of how to lose the game: If the player reaches 50 movement commands (i.e., 50 "go" commands),
the game ends in a loss. Non-movement commands such as "pick up", "drop", "deposit", "inventory", and "score" do not increase the move count.
